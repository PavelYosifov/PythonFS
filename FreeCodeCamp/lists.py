...
mylst2[1:1] = [
    "Test1",
    "Test2",
]  # inserts multiple arguments to the list at specified position
...
mylst3.sort(
    key=str.lower
)  # sorting the list in alphabetical order and escaping Upper case first
print(
    sorted(mylst3, key=str.lower)
)  # printing and sorting the list without modifying it
print(mylst3)
