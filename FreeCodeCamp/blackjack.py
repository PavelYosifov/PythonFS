...
class Deck:
    def __init__(self):
        ...
        ranks = [
            ...
            {"rank": "Q", "value": 10},
            {"rank": "K", "value": 10},
        ]  # List with ranks which are dictionaries
        for suit in suits:
            for rank in ranks:
    ...
    def shuffle(self):
        if len(self.cards) > 1:
            random.shuffle(self.cards)  # .shuffle is from random library
...
class Hand:
    ...
    def calculate_value(self):
        ...
        if has_ace and self.value > 21:
            self.value -= 10  # subtract 10 for Ace
...
class Game:
    def play(self):
        ...
        while game_number < games_to_play:
            ...
            print()
            print("*" * 30)  # it will print * 30 times
